...
let form=document.getElementById("form").addEventListener("submit",function(e){
    ...
    // let mdpConfirmer=document.getElementById("confirmer-mot-de-passe").value;
    ...
    //     email:email,
    //     mdp:mdp,
    //     mdpConfirmer:mdpConfirmer
    // }
    // localStorage.setItem(name,JSON.stringify(user));
    // alert("registration succssful palse login");
    validation(e)
...
function validation(e){
    ...
    // if(mdp==mdpConfirmer){
    //     alert("Un mot de passe existe déjà Veuillez saisir un mot de passe différent")
    ...
    // let namee=document.getElementById("nom").value;
    // let email=document.getElementById("email").value;
    // let mdp=document.getElementById("mot-de-passe").value;
    // let mdpConfirmer=document.getElementById("confirmer-mot-de-passe").value;
